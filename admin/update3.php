...
session_start();
    ...
    $id3 = $_GET['id3'];
    $var3 = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM `catalog-cart_1` WHERE (`id3`)"));
...
<!--admin-blocks--> 
                ...
                <h2 class="name-block_catalog">Блок сайта 3 - (Каталог)<p>Здесь Вы можете редактировать текстовую информацию блока сайта</p></h2>
<!--admin-block2-->
                <div class="all-blocks">
                    <div class="panels">                       
<!--form-->  
                        <form action="includes/save3.php" method="POST" id="admin-block3"   class="admin-block1" enctype="multipart/form-data">
                           <input type="hidden" value="<?php 
                            ...
                            <input type="hidden" name="title3" class="title" placeholder="Заголовок" value="Заголовок">
                            <input type="text" class="value" name="value3" value="<?php 
                            echo $var3["value3"]
                            ?>">

                            <p>Добавить описание:</p>
                            <input type="hidden" name="text3" class="title" placeholder="Описание" value="Описание">
                            <input type="text" id="mytextarea"  class="value_text" name="description3" value="<?php 
                            echo $var3["description3"]
                            ?>">
                    ...
                    <div class="block-add"> 
                        ...
                        <table class="table">                            
                            <tbody class="tbody">
                                ...
                                while($var2 = mysqli_fetch_assoc($catalogcart1)){
                                    echo '<tr>
                                    <td class="col">' . $var2["id3"] . '</td>
                                    <td class="col">' . $var2["title3"] . '</td> 
                                    <td class="col">' . $var2["value3"] . '</td>
                                    <td class="col">' . $var2["text3"] . '</td> 
                                    <td class="col">' . $var2["description3"] . '</td>
                                    <td class="col">' . $var2["image3"] . '</td>
                                    <td class="col">                                    
                                        
                                        <a type="button" class="fas fa-trash-alt" href="includes/delete-variable3.php?id =' . $var2["id3"] . '"></a>                            
                                    </td> 
                                </tr>';
                                }
                                ?>                            
